...
void nextgen(uint8_t* oldtable,uint8_t* newtable,int todo[][2],int howmany,int xsize,int ysize);
...
int main(int argc, char *argv[]) {
	...
	uint8_t* helptable = malloc(size*sizeof(uint8_t));
	...
	int* todo = malloc(howmany*2*sizeof(int));
...
void printer(uint8_t* screen,int xsize,int ysize, int xoffset,int yoffset, uint8_t* table){
