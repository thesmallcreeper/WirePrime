...
void printer(SDL_Surface* screen,int xsize,int ysize, int xoffset,int yoffset, uint_fast8_t* table);
void nextgen(uint_fast8_t* oldtable,uint_fast8_t* newtable,int todo[][2],int howmany,int xsize,int ysize);
void swap(uint_fast8_t **str1_ptr, uint_fast8_t **str2_ptr);
...
int main(int argc, char *argv[]) {
	...
	uint_fast8_t table[ysize+2][xsize+2];								
	uint_fast8_t helptable[ysize+2][xsize+2];
	...
	uint_fast8_t* helpptr;
	uint_fast8_t* ptrtable=table;									
	uint_fast8_t* ptrhelptable=helptable;
